    ...
    <div className="bg-white rounded-xl shadow-md p-5 md:p-6 mb-4 border border-gray-100 hover:shadow-lg transition-shadow">
      ...
      <div className="flex items-center gap-4 mb-4 pb-4 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-xs text-gray-500">平均契合度</div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-xs text-gray-500">潛在室友</div>
            <div className="text-xl font-bold text-purple-600">{user.matchStats.potentialMatchCount} 位</div>
          </div>
        </div>
      </div>
      ...
      {/* Preferences */}
      <div className="mb-4">
        <h4 className="text-sm font-bold text-gray-700 mb-2">{user.pronoun}在意的事：</h4>
      ...
      <div className="mb-4 bg-purple-50 rounded-lg p-3">
        <h4 className="text-sm font-bold text-purple-800 mb-2">適合什麼樣的人：</h4>
        <p className="text-sm text-purple-700 mb-3 break-keep">{user.suitableFor.description}</p>
        <div className="flex flex-wrap gap-3 text-xs text-gray-600">
          <div className="flex items-center gap-1">
            <MapPin size={14} className="text-orange-500" />
            <span>{user.suitableFor.location}</span>
          </div>
          <div className="flex items-center gap-1">
            <DollarSign size={14} className="text-green-500" />
            <span>{user.suitableFor.budgetRange}</span>
          </div>
        </div>
      </div>

      {/* CTA */}
      <button className="w-full bg-gradient-to-r from-orange-400 to-pink-500 text-white font-semibold py-3 px-4 rounded-lg hover:from-orange-500 hover:to-pink-600 transition-all flex items-center justify-center gap-2">
        <span>💭</span>
        <span>我覺得我可能適合欸</span>
        <span>→</span>
      </button>
