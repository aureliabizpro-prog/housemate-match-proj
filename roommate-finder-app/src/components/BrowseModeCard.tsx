    ...
    <div className="bg-white rounded-xl shadow-md p-5 md:p-6 mb-4 border border-gray-100 hover:shadow-lg transition-shadow break-keep">
      ...
      <div className="mb-4 break-keep">
        <div className="inline-flex items-center gap-2 bg-orange-50 px-4 py-2 rounded-full border border-orange-200">
          ...
          <span className="font-bold text-orange-500 break-keep" style={{ wordBreak: 'keep-all', overflowWrap: 'break-word' }}>
            {user.tagInfo.gender}<span style={{ whiteSpace: 'nowrap' }}> · </span>{user.tagInfo.highlightFeature}
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 mb-4 pb-4 border-b border-gray-100 break-keep">
        <div className="flex items-center gap-2">
          ...
          <div className="break-keep">
            ...
            <div className="text-xl font-bold text-green-500" style={{ whiteSpace: 'nowrap' }}>{user.matchStats.averageMatchScore}%</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="break-keep">
            ...
            <div className="text-xl font-bold text-orange-500 break-keep">
              <span style={{ whiteSpace: 'nowrap' }}>{user.matchStats.potentialMatchCount} 位</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-4 bg-green-50 rounded-lg p-3 border border-green-100 break-keep">
        <h4 className="text-sm font-bold text-green-500 mb-2" style={{ whiteSpace: 'nowrap' }}>適合什麼樣的人：</h4>
        <p className="text-sm text-green-600 mb-3 break-keep" style={{ wordBreak: 'keep-all', overflowWrap: 'break-word' }}>{user.suitableFor.description}</p>
      ...
      {/* CTA */}
      <button className="w-full bg-orange-300 text-white font-semibold py-3 px-4 rounded-lg hover:bg-orange-400 transition-all flex items-center justify-center gap-2 break-keep">
