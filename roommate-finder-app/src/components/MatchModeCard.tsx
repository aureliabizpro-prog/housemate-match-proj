    ...
    <div className="bg-white rounded-xl shadow-md p-5 md:p-6 mb-4 border border-gray-100 hover:shadow-lg transition-shadow">
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-3">
          {rank && (
            <div className="bg-gradient-to-br from-orange-400 to-pink-500 text-white font-bold text-lg w-10 h-10 rounded-full flex items-center justify-center">
              #{rank}
            </div>
          )}
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-gray-700">{match.matchedUser.email}</span>
            </div>
      ...
      <div className="mb-4 bg-gray-50 rounded-lg p-4">
        <h4 className="text-xs font-bold text-gray-600 mb-3 uppercase">配對分數細項</h4>
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">性別偏好</span>
            <div className="flex items-center gap-2">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">地點重疊</span>
            <div className="flex items-center gap-2">
              <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                <div
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">預算匹配</span>
            <div className="flex items-center gap-2">
              <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                <div
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">生活習慣</span>
            <div className="flex items-center gap-2">
              <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                <div
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h4 className="text-sm font-bold text-gray-700">為什麼推薦你們：</h4>
        </div>
        <ul className="space-y-2">
          {match.whyRecommended.map((reason, index) => (
            <li key={index} className="text-sm text-gray-600 flex items-start bg-purple-50 rounded-lg p-2">
      ...
      <div className="mb-4 border-t border-gray-100 pt-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h4 className="text-sm font-bold text-gray-700">室友的生活習慣：</h4>
        </div>
        <div className="grid grid-cols-2 gap-2 text-sm">
          <div className="bg-blue-50 rounded-lg p-2">
            <span className="text-gray-500">作息：</span>
            <span className="text-gray-700 font-medium ml-1">{match.lifestyle.schedule}</span>
          </div>
          <div className="bg-green-50 rounded-lg p-2">
            <span className="text-gray-500">清潔：</span>
            <span className="text-gray-700 font-medium ml-1">{match.lifestyle.cleaning}</span>
          </div>
          ...
          <div className="bg-purple-50 rounded-lg p-2">
            <span className="text-gray-500">互動：</span>
      ...
      {/* Quote (if exists) */}
      {match.quote && (
        <div className="mb-4 bg-gradient-to-r from-orange-50 to-pink-50 rounded-lg p-4 border-l-4 border-orange-400">
          <div className="flex items-start gap-2">
            <Users size={18} className="text-orange-500 mt-0.5 flex-shrink-0" />
            <div>
              <div className="text-xs text-gray-500 mb-1">室友說：</div>
      ...
      {/* CTA */}
      <button className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold py-3 px-4 rounded-lg hover:from-green-600 hover:to-emerald-700 transition-all flex items-center justify-center gap-2">
        <Mail size={18} />
        <span>聯絡這位室友</span>
      </button>
    </div>
